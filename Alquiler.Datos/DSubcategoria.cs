...
namespace Alquiler.Datos
{
    public class DSubcategoria
    {
        ...
        public string Existe(string Valor, int IdCategoria)
        {
            string Rpta = "";
            SqlConnection SqlCon = new SqlConnection();
            try
            {
                SqlCon = Conexion.getInstancia().CrearConexion();
                SqlCommand Comando = new SqlCommand("subcategoria_existe", SqlCon);
                Comando.CommandType = CommandType.StoredProcedure;
                Comando.Parameters.Add("@valor", SqlDbType.VarChar).Value = Valor;
        ...
        public string Actualizar(Subcategoria Obj)
        {
            ...
            try
            {
                ...
                Comando.CommandType = CommandType.StoredProcedure;
                Comando.Parameters.Add("@idsubcategoria", SqlDbType.Int).Value = Obj.IdSubcategoria;
                Comando.Parameters.Add("@idcategoria", SqlDbType.Int).Value = Obj.IdCategoria;
                Comando.Parameters.Add("@nombre", SqlDbType.VarChar).Value = Obj.Nombre;
        ...
        public string Eliminar(int Id)
        {
            ...
            try
            {
                ...
                Comando.CommandType = CommandType.StoredProcedure;
                Comando.Parameters.Add("@idsubcategoria", SqlDbType.Int).Value = Id;
                SqlCon.Open();
